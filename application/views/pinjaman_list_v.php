...
<thead>
	<tr>
		...
		<th data-options="field:'bunga', halign:'center', align:'right'" hidden="true"> Bagi Hasil</th>
		<th data-options="field:'bunga_txt', halign:'center', align:'right'" hidden="true"> Bagi Hasil</th>
					...
					<table>
						...
						<tr style="height:35px">
							...
							<td>
								...
								<input type="text" id="biaya_adm_txt" value="0" name="biaya_adm_txt" style=" background:#eee; border-width:1; width:195px; height:23px" readonly="true" />
							</td>	
						</tr>
						<tr style="height:35px">
...
function  create(){
	...
	// jQuery('#biaya_adm_txt').val('<?php echo '0'; ?>');
...
function save() {
	...
	$.getJSON("<?php echo site_url("pinjaman/islunas") ?>" + "/" + anggota_id,{
		format:"json"
	})
	.done(function(data){
		if(data == 'false'){
			alert("Anggota masih memiliki pinjaman yang belum lunas.");
		}else{savedata();}
	});
}
