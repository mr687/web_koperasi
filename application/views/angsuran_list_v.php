...
<div id="alur" class="easyui-dialog" show= "blind" hide= "blind" modal="true" resizable="false" style="width:500px; height:385px; padding-top: 10px" closed="true" style="display: none;">
	...
	<table>
		...
		<tr>
			<td></td>
			<td valign="top"> - </td>
			<td> Batas maksimal pembayaran adalah pada tanggal 15 (Lima Belas) setiap bulan, <code>Tanggal Dapat diubah pada menu Setting &raquo; Bagi Hasil</code></td>
		</tr>
		<tr>
